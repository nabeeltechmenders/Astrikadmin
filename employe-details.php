...
<head>
    ...
    <title>Astrik Manager | Employee Detail</title>
                            ...
                            <ul class="nav nav-tabs nav-justified mb-5 " id="" role="tablist">
                                <li class="nav-item me-0" role="presentation">
                                    <button class="nav-link text-start active p1 py-1" id="p1-tab-1"
                                        ...
                                        role="tab" aria-controls="p1-tab-pane" aria-selected="true"><i class="fa-solid fa-user px-2"></i> Personal Details
                                         </button>
                                </li>
                                <!-- <li class="nav-item me-0" role="presentation">
                                ...
                                <li class="nav-item me-0" role="presentation">
                                    <button class="nav-link text-start p3 py-1" id="p3-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="p3-tab-pane" aria-selected="false"><i class="fa-solid fa-id-card-clip px-2"></i> Employment Details
                                        </button>
                                </li>
                                <!-- <li class="nav-item me-0" role="presentation">
                                ...
                                <li class="nav-item me-0" role="presentation">
                                    <button class="nav-link text-start p5 py-1" id="p5-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="p5-tab-pane" aria-selected="false"><i class="fa-solid fa-building-columns px-2"></i>Financial Details
                                    </button>
                                </li>
                                ...
                                <li class="nav-item me-0" role="presentation">
                                    <button class="nav-link text-start p8 py-1" id="p8-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="p8-tab-pane" aria-selected="false"><i class="fa-solid fa-graduation-cap px-2"></i> Education Details
                                    </button>
                                </li>
