...
<head>
	...
	<title>Astrik Hrm | Profile</title>
            ...
            <div class="my-auto mb-2">
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item">
                            <a href="your-team.php">My Team</a>
                            </li>
                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            <span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
                                <img src="assets/img/users/user-13.webp" class="w-auto h-auto" alt="Img">
                            </span>
                            <div class="text-center px-3 pb-3 border-bottom">
                                <div class="mb-3">
                                    <h5 class="d-flex align-items-center justify-content-center mb-1">Stephan Peralt</h5>
                                    <span class="badge badge-soft-dark fw-medium me-2">
                                      Senior Software Developer
                                    </span>
                                    <span class="badge badge-soft-secondary fw-medium">Grade: H1</span>
                                </div>
                                <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="text-gray-9 mb-0">Saim Khan</p>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="row gx-2 mt-3 justify-content-center">
                                        ...
                                        <div class="col-6 d-none">
                                            <div>
                                                <a href="/chat" class="btn btn-primary w-100"><i class="ti ti-message-heart me-1"></i>Message</a>
                                            </div>
                                        </div>
                                    </div> -->
                                </div>
                            ...
                            <div class="p-3 border-bottom">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="javascript:void(0);" class="text-info d-inline-flex align-items-center"><span class="">admin@thetechmenders.com</span><i class="ti ti-copy text-dark ms-2"></i></a>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="d-inline-flex align-items-center">
                            ...
                            <div class="p-3 border-bottom">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <p class="text-dark text-end">Single</p>
                                </div>
                                <!-- <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="d-inline-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <p class="text-dark text-end">02</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-pane active show" id="bottom-justified-tab1" role="tabpanel">
                                <div class="accordion accordions-items-seperate" id="accordionExample">
                                        ...
                                        <div class="col-md-6">
                                            <div class="accordion-item">
                                                <div class="row">												
                                                        ...
                                                        <div class="accordion-button">
                                                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <a href="#" class="d-flex align-items-center collapsed collapse-arrow" data-bs-toggle="collapse" data-bs-target="#primaryBorder9" aria-expanded="false" aria-controls="primaryBorder9">
                                                                        <i class="ti ti-chevron-down fs-18"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="primaryBorder9" class="accordion-collapse collapse border-top show" aria-labelledby="heading9" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">Feburary 2025</h6>
                                                                        <a href="pay-slip.php" class="fs-12 text-primary">View payslip</a>
                                                                        </div>
                                                                        <p class="text-dark">Rs.36000</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">January 2025</h6>
                                                                        <a href="pay-slip.php" class="fs-12 text-primary">View payslip</a>
                                                                        </div>
                                                                        <p class="text-dark">Rs.36000</p>
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">December 2024</h6>
                                                                        <a href="pay-slip.php" class="fs-12 text-primary">View payslip</a>
                                                                        </div>
                                                                        <p class="text-dark">Rs.36000</p>
                                                                    </div>
                                                ...
                                                <div class="row">												
                                                    <div class="accordion-header" id="heading8">
                                                        <div class="accordion-button collapsed">
                                                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                                                <h5>Bonus & Incentives</h5>														
                                                                <div class="d-flex">
                                                                    <!-- <a href="#" class="btn btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#edit_experience"><i class="ti ti-edit"></i></a> -->
                                                                    <a href="#" class="d-flex align-items-center collapsed collapse-arrow" data-bs-toggle="collapse" data-bs-target="#primaryBorder8" aria-expanded="false" aria-controls="primaryBorder8">
                                                                        <i class="ti ti-chevron-down fs-18"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="primaryBorder8" class="accordion-collapse collapse border-top show" aria-labelledby="heading8" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div>
                                                            <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">December </h6>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">Febuary </h6>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                        <div>
                                                                        <h6 class="d-block align-items-center mt-1">January  </h6>
                                                                        <span class="fs-12 fw-medium text-success"><i class="fa-solid fa-caret-up me-1"></i>+2.1%</span>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="primaryBorderTwo" class="accordion-collapse collapse border-top show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <span class="d-inline-flex align-items-center">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">42101-12345678-9</h6>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <span class="d-inline-flex align-items-center">
                                                            Branch
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="primaryBorderThree" class="accordion-collapse collapse border-top show" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="row justify-content-between mb-3">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">42101-012345678-9</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-between mb-3">
                                                    <div class="col-md-2">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">Maria Peralt</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Relationship
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">Mother</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Date of birth
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">15 March 1980</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Phone
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1"> +1 265 7845 321</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                           CNIC
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">42101-987654321-0</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-between mb-3">
                                                    <div class="col-md-2">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">James Peralt</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Relationship
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">10 August 2010</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Phone
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1"> +1 265 6956 962</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                           CNIC
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">42101-112233445-6</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-between mb-3">
                                                    <div class="col-md-2">
                                                        ...
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">Sophia Peralt</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Relationship
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">Sister</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Date of birth
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">5 December 2016</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                            Phone
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1"> +1 265 6956 963</h6>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <span class="d-inline-flex align-items-center">
                                                           CNIC
                                                        </span>
                                                        <h6 class="d-flex align-items-center fw-medium mt-1">42101-223344556-7</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="accordion-item">
                                                <div class="row">												
                                                    ...
                                                    <div id="primaryBorderFour" class="accordion-collapse collapse border-top show" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div>
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            <div class="accordion-item">
                                                <div class="row">												
                                                    ...
                                                    <div id="primaryBorderFive" class="accordion-collapse collapse border-top show" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div>
                                                                <div class="mb-3">
                                                                    <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="card flex-fill mb-4 mb-md-0">
                                                                <div class="card-body">
                                                                    <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                                                        <a href="/project-details" class="flex-shrink-0 me-2">
                                                                            <img src="assets/img/social/project-03.svg" alt="Img">
                                                                        </a>
                                                                        <div>
                                                                            <h6 class="mb-1"><a href="/project-details">World Health</a></h6>
                                                                            <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div>
                                                                                ...
                                                                                <a href="#" class="fw-normal d-flex align-items-center">
                                                                                    <img class="avatar avatar-sm rounded-circle me-2" src="assets/img/profiles/avatar-01.webp" alt="Img">
                                                                                    Leona
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="card flex-fill mb-0">
                                                                <div class="card-body">
                                                                    <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                                                        ...
                                                                        <div>
                                                                            <h6 class="mb-1 text-truncate"><a href="/project-details">Hospital Administration</a></h6>
                                                                            <div class="d-flex align-items-center">
                                                                                <p class="mb-0 fs-13">8 tasks</p>
                                                                                <p class="fs-13"><span class="mx-1"><i class="ti ti-point-filled text-primary"></i></span>15 Completed</p>
                                                                            </div>
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div>
                                                                                    <h6 class="mb-1"><a href="/project-details">Dell Laptop - #343556656</a></h6>
                                                                                    <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div>
                                                                                    <h6 class="mb-1"><a href="/project-details">Bluetooth Mouse  - #478878</a></h6>
                                                                                    <div class="d-flex align-items-center">
                                                                                            <p><span class="text-primary">AST - 001<i class="ti ti-point-filled text-primary mx-1"></i></span>Assigned on 22 Nov, 2022 10:32AM </p>
                                                                                    </div>
                                                                                </div>
