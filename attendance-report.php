...
<head>
	...
	<title>Astrik Manager | My Team Attendance</title>
    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">My Team Attendance</h2>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">My Team Attendance</li>
                    </ol>
                </nav>
            </div>
