...
<head>
	...
	<title>Astrik Manager | Team Attendance</title>
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="index.php"> Manager Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Team Attendance</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center overflow-hidden mb-2">
                                    ...
                                    <div class="ms-2 overflow-hidden">
                                        <p class="fs-12 fw-normal mb-1 text-truncate">Total Team Members</p>
                                        <h4>25</h4>
                                    </div>
                                </div>
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="d-flex align-items-center overflow-hidden mb-2">
                                    ...
                                    <div class="ms-2 overflow-hidden">
                                        <p class="fs-12 fw-normal mb-1 text-truncate">Total Absents</p>
                                        <h4>12</h4>
                                    </div>
                                </div>
                                <div class="attendance-report-bar mb-2">
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="d-flex align-items-center overflow-hidden mb-2">
                                    ...
                                    <div class="ms-2 overflow-hidden">
                                        <p class="fs-12 fw-normal mb-1 text-truncate">Total Half days</p>
                                        <h4>6</h4>
                                    </div>
                                </div>
                                <div class="attendance-report-bar mb-2">
            ...
            <!-- <div class="col-xl-6 ">
                <div class="card">
                    ...
                    <div class="card-body py-0 px-2">
                        <img src="assets/img/attendence-graph.PNG" class="img-fluid mb-2">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                    <div class="me-3">
                        ...
                        <div class="position-relative">
                            ...
                            <!-- <input type="text" class="form-control date-range " placeholder="dd/mm/yyyy - dd/mm/yyyy">
                            <span class="input-icon-addon">
                                <i class="ti ti-chevron-down"></i>
                            </span> -->
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="">
                                <a href="my-attendance.php" class="text-primary fs-12">View all attendance</a>
                                </td>
                            </tr>
                            <tr>										
                                <td>
                            ...
                            <tr>										
                                <td>
                                    <div class="d-flex align-items-center">
                                    <a href="assets/img/users/user-02.webp" data-fancybox="gallery" data-caption="" class="avatar avatar-md">
                            ...
                            <tr>										
                                <td>
                                    <div class="d-flex align-items-center">
                                    <a href="assets/img/users/user-37.webp" data-fancybox="gallery" data-caption="" class="avatar avatar-md">  
                            ...
                            <tr>										
                                <td>
                                    <div class="d-flex align-items-center">
                                    <a href="assets/img/users/user-38.webp" data-fancybox="gallery" data-caption="" class="avatar avatar-md">
