...
<head>
	...
	<title>Astrik Hrm | Attendance Employee</title>
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <!-- <div class="me-2 mb-2">
                        <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                            <a href="attendance-employee.php" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-brand-days-counter"></i></a>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <div class="badge badge-md badge-primary mb-3">Productive Hours :  3.45 hrs</div>
                            ...
                            <div class="text-center mt-3">
                              <a href="" class="text-primary text-decoration-underline" >Mark Break</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                        ...
                        <div class="dropdown me-3">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item rounded-1">Half Day</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item rounded-1">Late</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item rounded-1">Off Day/Holiday</a>
                                </li>
                                <li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>20 Min</td>
                                    <td>
                                        <span class="text-success">8.55 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.55 Hrs</span>
                                    </td>
                                    <!-- <td>
                                    ...
                                    <td>
                                        <span class="badge badge-success d-inline-flex align-items-center">
                                            <i class="ti ti-clock-hour-11 me-1"></i>9.00 Hrs
                                        </span>
                                    </td>										 -->
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-secondary-transparent d-inline-flex align-items-center">
                                            <i class="ti ti-point-filled me-1"></i> Off Day/Holiday
                                        </span>
                                    </td>
                                    <td>20 Min</td>
                                    <td>
                                    ...
                                    <td>45 Min</td>
                                    <td>
                                        <span class="text-danger">6.55 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.55 Hrs</span>
                                    </td>										
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-success">9.00 Hrs</span>
                                    </td>									
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>50 Min</td>
                                    <td>
                                        <span class="text-danger">7.25 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.55 Hrs</span>
                                    </td>									
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-success">9.55 Hrs</span>
                                    </td>								
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <span class="text-danger">7.15 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.15 Hrs</span>
                                    </td>									
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge badge-warning-transparent d-inline-flex align-items-center">
                                            <i class="ti ti-point-filled me-1"></i>Late
                                        </span>
                                    </td>
                                    <td>14 Min</td>
                                    <td>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <span class="text-success">8.35 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.35 Hrs</span>
                                    </td>										
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>45 Min</td>
                                    <td>
                                        <span class="text-success">8.25 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-success">9.25 Hrs</span>
                                    </td>										
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <span class="text-success">8.40 Hrs</span>
                                    </td>
                                    <td>
                                        <span class="text-danger">8.40 Hrs</span>
                                    </td>										
                                </tr>
                            </tbody>
                        </table>
